...
std::string AttributeInfo::toString()
{
	...
	output += "Attribute Name: " + name + "\n" + 
				"Number of Distict Values: " + Util::toString<int>(numDistincts);
	return output;
}
...
{
	std::string output;
	output += "Relation Name: " + name + "\n" + 
				"Number of Tuples: " + Util::toString<int>(numTuples) + "\n";
			
	int num_atts = data.size();
	output += "Number of Attributes: " + Util::toString<int>(num_atts) + "\n";
...
void Statistics::AddRel(char *relName, int numTuples)
{
    ...
    {
        //std::cerr << "[Warning] In function Statistics::AddRel(): Relation '" << relation_name << "' has existed in Statistics, it will be updated" << std::endl;     
        data[relation_name].numTuples = numTuples;
    }
    else
    { // relation name not exists 
...
std::string Statistics::joinedRelToStr()
{
    ...
    output += "Number of Relations Joined Together: " + Util::toString<int>(join_rel_size) + "\n";
    for (std::map<std::string, RelationInfo*>::iterator it = joined_relations.begin(); it != joined_relations.end(); it++)
    {
        output += "Single Relation Name: " + it->first + "\n" + "Joined Relation name" + it->second->name + "\n";
    }
    return output;
}
...
void Statistics::Write(char *fromWhere)
{
    ...
    output += "Number of Relations: " + Util::toString<int>(num_relations) + "\n";
                                    ...
                                    char *relNames[], int numToJoin)
{
    ...
    std::string new_rel_name = relation_left->name + "_JOIN_" + relation_right->name;
