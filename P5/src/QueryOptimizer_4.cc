...
void SelectNode::execute(const std::map<int, Pipe*> &pipes) {
    if (type == SELECT_FILE) {
        std::cout << "Executeing SELECT_FILE Node: " << std::endl;
        db = new DBFile();
        ...
        std::cout << "Executeing SELECT_PIPE Node: " << std::endl;
...
void JoinNode::execute(const std::map<int, Pipe*> &pipes) {
    std::cout << "Executeing Join Node: " << std::endl;
    Join *j = new Join();
    std::cout << "Start Run Join Node: " << std::endl;
...
void SumNode::execute(const std::map<int, Pipe*> &pipes) {
    std::cout << "Executeing SUM Node: " << std::endl;
    Sum *s = new Sum();
...
void GroupByNode::execute(const std::map<int, Pipe*> &pipes) {
    std::cout << "Executeing GroupBy Node: " << std::endl;
...
void DupRemovalNode::execute(const std::map<int, Pipe*> &pipes) {
    std::cout << "Executeing DupRemoval Node: " << std::endl;
...
void WriteOutNode::execute(const std::map<int, Pipe*> &pipes) {
    std::cout << "Executeing WriteOutNode Node: " << std::endl;
